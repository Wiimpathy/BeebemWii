...
#define EG_COLOR_NORMAL CalcColor(72+16, 63+16, 52+16)

#define EG_COLOR_ALT		( (SDL_Color) {191, 0, 0, 0} )

//#define EG_COLOR_NORMAL               ( (SDL_Color) {239, 206, 140, 0} )
//#define EG_COLOR_ALT 		( (SDL_Color) {191, 0, 0, 0} )
...
//#define DARKER_MENU_COLORS CalcColor(127, 127,127)
//#define VERY_DARK_MENU_COLORS CalcColor(96, 96, 96)


#define MENU_COLORS CalcColor(72, 63, 52)
#define DARKER_MENU_COLORS CalcColor(72-8, 63-8, 52-8)
#define VERY_DARK_MENU_COLORS CalcColor(72-16, 63-16, 52-16)



//#define MENU_COLORS CalcColor(239, 206, 140)
//#define DARKER_MENU_COLORS CalcColor(239-20, 206-20, 140-20)
//#define VERY_DARK_MENU_COLORS CalcColor(239-40, 206-40, 140-40)
