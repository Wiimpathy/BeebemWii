...
#define EG_BOX_BORDER_NONE 	EG_GRAPHICS_BORDER_NORMAL
#define EG_BOX_BORDER_RAISED	EG_GRAPHICS_BORDER_RAISED
#define EG_BOX_BORDER_SUNK	EG_GRAPHICS_BORDER_SUNK
